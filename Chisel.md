...
``` # Snapshot
 ...
 ```
 creates file >snapshot > telling Gas amount spent

```
 Constants have all UPPERCASE
 Immutable variables have i_name
 Storage variables have s_name
```
This little Code conventions will make your code clean and professional, plus way easier to read.